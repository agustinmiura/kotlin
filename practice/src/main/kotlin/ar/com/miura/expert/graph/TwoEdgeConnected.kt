...
class TwoEdgeConnected {
     ...
     *
     */
    private fun getMinAmountArrivalTimeOfAncestors(currentVertex:Int, parent:Int, currentTime:Int, arrivalTimes:IntArray, edges:List<List<Int>>):Int {
        ...
        for(destination in edges[currentVertex]) {
            ...
            if (arrivalTimes[destination] == -1) {
                minArrivalTime = Math.min(minArrivalTime, getMinAmountArrivalTimeOfAncestors(
                    destination,
                    currentVertex,
                    currentTime+1,
                    arrivalTimes,
